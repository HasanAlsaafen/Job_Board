...
return [
    ...
    'defaults' => [
        ...
        'scanOptions' => [
             ...
             *
             * l5-swagger's default analyser only parses PHP 8 attributes. This app's
             * controllers use classic `@OA\...` PHPDoc annotations, so both factories
             * are registered here to support them alongside attributes.
             *
             * @see \OpenApi\scan
             */
