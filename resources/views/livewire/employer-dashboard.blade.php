...
<div class="{{ app()->isLocale('ar') ? 'lg:mr-64' : 'lg:ml-64' }} flex flex-col min-h-screen text-black bg-white" dir="{{ app()->isLocale('ar') ? 'rtl' : 'ltr' }}">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
            ...
            <form wire:submit.prevent="createJob" class="space-y-4 text-sm">
                <div>
                    ...
                    <input type="text" wire:model="title" placeholder="{{ __('messages.job_form.job_title_placeholder') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900">
                    @error('title') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>

                <div>
                    <label class="block font-medium text-gray-700 mb-1">{{ __('messages.job_form.company_name') }}</label>
                    <input type="text" wire:model="company_name" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900">
                    @error('company_name') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>
                <div>
                    <label class="block font-medium text-gray-700 mb-1">{{ __('messages.job_form.location') }}</label>
                    <input type="text" wire:model="location" placeholder="{{ __('messages.job_form.location_placeholder') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900">
                ...
                <div>
                    ...
                    <select wire:model="type" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900">
                ...
                <div>
                    ...
                    <input type="text" wire:model="salary_range" placeholder="{{ __('messages.job_form.salary_placeholder') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900">
                </div>

                <div>
                    <label class="block font-medium text-gray-700 mb-1">{{ __('messages.job_form.description') }}</label>
                    <textarea wire:model="description" rows="4" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"></textarea>
                    @error('description') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>

                <div>
                    <label class="block font-medium text-gray-700 mb-1">{{ __('messages.job_form.requirements') }}</label>
                    <textarea wire:model="requirements" rows="3" placeholder="{{ __('messages.job_form.requirements_placeholder') }}" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-900"></textarea>
                    @error('requirements') <span class="text-red-500 text-xs">{{ $message }}</span> @enderror
                </div>

                <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 rounded-xl transition">
